#
#  Be sure to run `pod spec lint MitRegx.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of MitRegx in Markdown format.
  ...
  s.source       = { :git => "https://github.com/mcmengchen/MitRegx.git", :tag => "0.0.1" }
